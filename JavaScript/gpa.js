  ...
  if (btn) {
    btn.addEventListener("click", () => {
      ...
      let totalGradePoints =
        parseInt(gradePoint1) +
        parseInt(gradePoint2) +
        parseInt(gradePoint3) +
        parseInt(gradePoint4) +
        parseInt(gradePoint5);

      let totalCredits =
        parseInt(creditInput1) +
        parseInt(creditInput2) +
        parseInt(creditInput3) +
        parseInt(creditInput4) +
        parseInt(creditInput5);

      let gpa = totalGradePoints / totalCredits;

      let totalGPA = (document.getElementById("total-gpa").innerText =
        gpa.toFixed(1));
    });
  }
};
